#ifndef _LT_FIX_DUPLICATED_IMPORT_SDIMAGECACHE_H_ 
#define _LT_FIX_DUPLICATED_IMPORT_SDIMAGECACHE_H_
/*
...
#endif /* _LT_FIX_DUPLICATED_IMPORT_SDIMAGECACHE_H_ */
