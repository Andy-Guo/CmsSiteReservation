...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _yesterday = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 50, HEADERVIEW_HEIGHT)];
        [_yesterday setBackgroundColor:RGBACOLOR(228,33,18,1)];
        ...
        _tomorrow = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 50, HEADERVIEW_HEIGHT)];
        [_tomorrow setBackgroundColor:RGBACOLOR(228,33,18,1)];
        [_tomorrow setTitle:@"前一天" forState:UIControlStateNormal];
        ...
        _today = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 50, HEADERVIEW_HEIGHT)];
        [_today setBackgroundColor:RGBACOLOR(228,33,18,1)];
        [_today setTitle:@"前一天" forState:UIControlStateNormal];
